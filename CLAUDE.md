...
커밋 직전에 항상 `README.md`를 최신 상태로 갱신합니다.

- 프로젝트 현황 (Phase 진행 상태 등) 업데이트
- 새로 추가된 기능/문서 반영
- 설치/실행 방법이 변경된 경우 업데이트

## flow.md 기록 규칙

모든 대화에서 사용자의 요청과 수행 작업을 `docs/flow.md`에 누적 기록합니다.
...
- **기록 형식**:
  ...
  **결과:** 작업 결과 또는 산출물
  ```
- 날짜가 바뀌면 새로운 날짜 헤더(`## YYYY-MM-DD`)를 추가합니다.
- `docs/flow.md`가 없으면 자동으로 생성합니다.
