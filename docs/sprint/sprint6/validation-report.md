...
| `ErrorResponseTest` | 2 | 구조화 에러 응답 포맷 |
...
| `BatchTaggingServiceTest` | 1 | API 키 미설정 동작 |
| `TaggingServiceTest` | 1 | 태그 생성 서비스 |
| `WallpaperSearchApiTest` | 2 | 검색 API MockMvc |
| `LikeApiTest` | 2 | 좋아요 토글 API |
| **합계** | **50** | |
